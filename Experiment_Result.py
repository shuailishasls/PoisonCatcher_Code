...
if __name__ == "__main__":
	...
	times = 3 if input('实验几？') == '5' else 32
	epsilon, confidence_level, threshold = 1, 0.9, 0.5
	...
	if times == 32:
		...
		result_df_5.to_csv(f'./File/Experiment_5_Identify_Attacked_Data.csv', index=False)
		result_df_5_1.to_csv(f'./File/Experiment_5_1_Identify_Attacked_Data.csv', index=False)
